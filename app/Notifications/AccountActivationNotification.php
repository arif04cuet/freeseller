...
class AccountActivationNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->lineIf($role == SystemRole::Reseller->value, new HtmlString('1. Joining our WhatsApp reseller group via  <a href="' . $whatsAppLink . '">WhatsApp</a>'))
            ->lineIf($role == SystemRole::Reseller->value, new HtmlString('2. Watch our small videos about how to do reselling at FreeSeller on <a href="' . $youTubeLink . '">YouTube</a>'))
